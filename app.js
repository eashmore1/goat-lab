...
const teamEras = [
  ...
  },
  {
    ...
    players: [
      ...
      player("Joe Johnson", 6, 7, 2, { height: 84, shooting: 88, finishing: 88, handles: 84, passing: 84, defense: 78, rebounding: 70, athleticism: 84, iq: 88 }),
  ...
  },
  {
    ...
    players: [
      player("Paul George", 6, 8, 24, { height: 86, shooting: 88, finishing: 88, handles: 82, passing: 80, defense: 93, rebounding: 76, athleticism: 86, iq: 88 }),
  ...
  },
  {
    ...
    players: [
      ...
      player("Joe Johnson", 6, 7, 2, { height: 84, shooting: 88, finishing: 87, handles: 84, passing: 80, defense: 74, rebounding: 64, athleticism: 82, iq: 86 }),
  ...
  },
  {
    ...
    players: [
      player("Joe Johnson", 6, 7, 7, { height: 84, shooting: 88, finishing: 86, handles: 84, passing: 80, defense: 72, rebounding: 64, athleticism: 80, iq: 88 }),
...
const goldenTeams = [
  ...
  },
  {
    ...
    players: [
      ...
      player("Darryn Peterson",   6, 5,  2,  { height: 80, shooting: 84, finishing: 88, handles: 88, passing: 80, defense: 86, rebounding: 68, athleticism: 100, iq: 84 }),
      player("Cameron Boozer",    6, 9,  35, { height: 88, shooting: 80, finishing: 88, handles: 72, passing: 72, defense: 84, rebounding: 100, athleticism: 86, iq: 82 }),
      player("Caleb Wilson",      6, 7,  3,  { height: 84, shooting: 82, finishing: 84, handles: 80, passing: 100, defense: 76, rebounding: 74, athleticism: 82, iq: 88 }),
      player("Keaton Wagler",     6, 6,  5,  { height: 82, shooting: 100, finishing: 84, handles: 78, passing: 74, defense: 72, rebounding: 66, athleticism: 80, iq: 84 }),
      player("Mikel Brown Jr.",   6, 4,  4,  { height: 76, shooting: 82, finishing: 86, handles: 100, passing: 80, defense: 82, rebounding: 64, athleticism: 90, iq: 82 }),
      player("Darius Acuff",      6, 5,  11, { height: 80, shooting: 88, finishing: 100, handles: 86, passing: 76, defense: 78, rebounding: 66, athleticism: 88, iq: 82 }),
      player("Kingston Flemings", 6, 4,  0,  { height: 76, shooting: 84, finishing: 86, handles: 84, passing: 76, defense: 84, rebounding: 66, athleticism: 100, iq: 82 }),
      player("Morez Johnson Jr.", 6, 9,  15, { height: 90, shooting: 68, finishing: 88, handles: 68, passing: 68, defense: 90, rebounding: 90, athleticism: 100, iq: 78 }),
      player("Brayden Burries",   6, 4,  10, { height: 76, shooting: 86, finishing: 84, handles: 88, passing: 86, defense: 76, rebounding: 60, athleticism: 80, iq: 100 }),
      player("Yaxel Lendeborg",   6, 8,  13, { height: 86, shooting: 74, finishing: 84, handles: 68, passing: 70, defense: 86, rebounding: 100, athleticism: 84, iq: 78 }),
      player("Aday Mara",         7, 3,  12, { height: 100, shooting: 74, finishing: 86, handles: 62, passing: 70, defense: 92, rebounding: 92, athleticism: 78, iq: 82 }),
      player("Nate Ament",        6, 7,  14, { height: 84, shooting: 74, finishing: 80, handles: 70, passing: 70, defense: 100, rebounding: 82, athleticism: 86, iq: 82 }),
  ...
  },
  {
    ...
    players: [
      ...
      player("Jordan Clarkson",    6, 5,  0,  { height: 80, shooting: 94, finishing: 92, handles: 90, passing: 76, defense: 70, rebounding: 64, athleticism: 84, iq: 82 }),
      player("Mitchell Robinson",  7, 1,  13, { height: 100, shooting: 52, finishing: 84, handles: 56, passing: 60, defense: 96, rebounding: 96, athleticism: 88, iq: 74 }),
      player("Miles McBride",      6, 2,  2,  { height: 70, shooting: 84, finishing: 82, handles: 86, passing: 80, defense: 86, rebounding: 60, athleticism: 82, iq: 84 }),
      player("Landry Shamet",      6, 4,  14, { height: 76, shooting: 92, finishing: 80, handles: 80, passing: 76, defense: 72, rebounding: 60, athleticism: 76, iq: 84 }),
    ],
  },
];
